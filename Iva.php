...
$query = "SELECT * FROM iva LIMIT $start_from, $per_page_record ";
...
<body style="background-color: #fff;overflow: auto !important;">
                ...
                <div class="container-fluid">
                    <div class="col-sm-12 col-xs-12">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    if (!empty($_POST)) {
                                        ...
                                        $query = "SELECT * FROM iva WHERE nombre like '%" . $aKeyword[0] . "%' OR nombre like '%" . $aKeyword[0] . "%' OR nombre like '%" . $aKeyword[0] . "%'OR nombre like '%" . $aKeyword[0] . "%'";
                                        ...
                                        if ($query !== false) {
                                            ...
                                            ?>
                                                <tr>
                                                    <td><?php echo $row['nombre']; ?></td>
                                                    <td><?php echo $row['codigo_Iva']; ?></td>
                                                    <td><a class="btn btn" style="Background-color:#006666;color:#ffffff;" href="EditarIva.php?id=<?php echo $row['id']; ?>"><i class="fa fa-edit"></i></a></td>
                                                    <td><a class="btn btn-danger" href="Controladores/Iva/Eliminar.php?id=<?php echo $row['id']; ?>"><i class="fa fa-trash"></i></a></td>
                                                </tr>
                                    <?php }
                                        }
                                    }
                        ...
                        height: 100px;">
                                ...
                                if ($page >= 2) {
                                    echo "<li class='page-item'><a class='page-link' style='color:white; background-color:#006666;' href='Iva.php?page=" . ($page - 1) . "'> Anterior </a></li>";
                                }

                                for ($i = 1; $i <= $total_pages; $i++) {
                                    if ($i == $page) {
                                        $pagLink .= "<li class='page-item'><a style='color:white; background-color:#006666;' class = 'page-link active' href='Iva.php?page=" . $i . "'>" . $i . " </a></li>";
                                    } else {
                                        $pagLink .= "<li class='page-item'><a style='color:white; background-color:#006666;' class='page-link'href='Iva.php?page=" . $i . "'>   
                                                " . $i . " </a></li>";
                                    }
                                };
                                echo $pagLink;
                                if ($page < $total_pages) {
                                    echo "<li class='page-item'><a  class='page-link' href='Iva.php?page=" . ($page + 1) . "'>  Siguiente </a></li>";
                                } ?>
                            </div>
                        </nav>
                        <div class="inline">
    ...
    <script>
        function go2Page() {
            ...
            window.location.href = 'Iva.php?page=' + page;
        }
    </script>
</body>
